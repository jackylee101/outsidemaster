...
@Component
public class PaceStyle4 extends PaceBase implements PaceStyle {
	...
	public QueryForm pace10(String custId, String prjItmId, String prjDtlId) {
		...
		key1o.put("key", "01");
		key1o.put("sourceCol", "COL006");
		key1.add(key1o);

		Map key2o = new HashMap();
		key2o.put("key", "02");
		key2o.put("sourceCol", "COL004");
		key2.add(key2o);

		Map key3o = new HashMap();
		key3o.put("key", "03");
		key3o.put("sourceCol", "COL005");
		key3.add(key3o);
		...
		sortKey2o.put("sourceCol", "COL006");

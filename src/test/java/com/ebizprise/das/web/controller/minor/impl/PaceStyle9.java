...
@Component
public class PaceStyle9 extends PaceBase implements PaceStyle {
	...
	public QueryForm pace10(String custId, String prjItmId, String prjDtlId) {
		...
		sortKey3o.put("sourceCol", "COL003");
		sortKey3.add(sortKey3o);

		Map sortKey4o = new HashMap();
		sortKey4o.put("sourceCol", "COL004");

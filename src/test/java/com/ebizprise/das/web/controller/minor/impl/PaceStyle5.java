...
@Component
public class PaceStyle5 extends PaceBase implements PaceStyle {
	...
	public QueryForm pace10(String custId, String prjItmId, String prjDtlId) {
		...
		key2o.put("key", "02");
		key2o.put("sourceCol", "COL008");
		key2.add(key2o);

		Map key3o = new HashMap();
		key3o.put("key", "03");
		key3o.put("sourceCol", "COL007");
		key3.add(key3o);

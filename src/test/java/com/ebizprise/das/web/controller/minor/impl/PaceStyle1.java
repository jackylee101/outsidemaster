...
@Component
public class PaceStyle1 extends PaceBase implements PaceStyle {
	...
	public PaceStyle1(String realHost) {
	...
	public QueryForm pace10(String custId, String prjItmId, String prjDtlId) {
		...
		sortKey4o.put("sourceCol", "COL001");

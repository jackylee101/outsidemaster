...
public class HttpUtils {
	...
	public static HttpResponse doPost(String host, String path, String method,
			Map<String, String> headers, Map<String, String> querys,
			List<NameValuePair> nameValuePairList, String rowmessage) throws Exception {
		HttpClient httpClient = wrapClient(host);
...
//			}
		...
		if (StringUtils.isNotBlank(rowmessage)) {
			request.setEntity(new StringEntity(rowmessage, "UTF8"));
		}

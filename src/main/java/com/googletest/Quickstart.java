...
/**
 * https://developers.google.com/sheets/api/quickstart/java 1. 建立 Google API
 * Console 及註冊
...
public class Quickstart {
	...
	public static Credential authorize() throws IOException {
		// Load client secrets.
		InputStream in = Quickstart.class.getResourceAsStream("/My Project 78220-8e3fa6257e86.json");
		GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, new InputStreamReader(in));

		// Build flow and trigger user authorization request.
		GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(HTTP_TRANSPORT, JSON_FACTORY,
				clientSecrets, SCOPES).setDataStoreFactory(DATA_STORE_FACTORY).setAccessType(null).build();
	...
	public static void main(String[] args) throws IOException {
		...
		String spreadsheetId = "1waW7SIPy4ml8CreNHvkFjsDeaxkp6ifM-HPXxSwLvac";
